...
function selectRandom(arr) {
  ...
  const randomARR = Math.floor(Math.random() * 3) + 1;
  if (randomARR === 1) {
    let randomElement = Math.floor(Math.random() * 6);
    return suspectsArray[randomElement];
  } else if (randomARR === 2) {
    let randomElement = Math.floor(Math.random() * 9);
    return weaponsArray[randomElement];
  } else if (randomARR === 3) {
    let randomElement = Math.floor(Math.random() * 15);
    return roomsArray[randomElement];
  }
}
*/
